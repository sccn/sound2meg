...
#       if np.cumsum(self.sizes)[i] > idx:          #This way we will know the ranges of the different MEG Signal samples in the context of the entire dataset. # dutruong - to determine which elem of self.sizes the idx corresponds to. This means samples are consecutive. Have to make sure shuffling.
...
#     #Baseline Correction
#     mean_5 = np.mean(MEG_Signal[:,:60], axis=1) # dutruong - ERROR: second baseline removal
