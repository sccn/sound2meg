...
Training_Data_Batches = DataLoader(training_data, batch_size = 2048, shuffle = True)
Validation_Data_Batches = DataLoader(validation_data, batch_size = 2048, shuffle = True)
...
for i in range(1):
  ...
  for MEG, WAV, Sub in Training_Data_Batches:
    ...
    optimizer.step()
  print('')
  print("Training loss: " + str(loss_t/len(Training_Data_Batches)), end='')
  ...
  print('')
  print("Validation loss: " + str(loss_v/len(Validation_Data_Batches)))
