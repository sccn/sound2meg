  ...
  def forward(self, X):
    ...
    # Question: divide this with square root of KxK? to stablize gradient as with self-attention?
        for i in range(a.shape[1]):
            distance = (self.x_drop - x_coord[i])**2 + (self.y_drop - y_coord[i])**2
            if distance < 0.1:
                a[:, i] = 0
...
positions24 = torch.tensor(np.array([[0.30092572, 0.88731952],
       [0.55489618, 0.88731952],
       [0.09445365, 0.68381173],
       [0.25465154, 0.70267879],
       [0.42791095, 0.7739043 ],
       [0.60117036, 0.70267879],
       [0.76136825, 0.68381173],
       [0.26077044, 0.56342701],
       [0.42791095, 0.59546076],
       [0.59505146, 0.56342701],
       [0.03776842, 0.36906382],
       [0.23586744, 0.47872768],
       [0.61995446, 0.47872768],
       [0.81805348, 0.36906382],
       [0.21313013, 0.38439431],
       [0.42791095, 0.39927409],
       [0.64269177, 0.38439431],
       [0.12407942, 0.17895374],
       [0.20661582, 0.29816212],
       [0.42791095, 0.229042  ],
       [0.64920608, 0.29816212],
       [0.73174248, 0.17895374],
       [0.29176047, 0.04082929],
       [0.42791095, 0.46874023]]))
